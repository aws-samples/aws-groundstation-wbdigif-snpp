...
Following the [Simulcast manual](./docs/Simulcast_7.0_Users_Guide.pdf) you can install the Simulcast software from [here](./software/SIMULCAST_7.0.tar.gz) onto the EC2 instance with Blink or on another EC2 instance reachable over TCP from the Blink EC2 instance.
